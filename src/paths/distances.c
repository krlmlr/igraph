...
igraph_error_t igraph_radius(const igraph_t *graph, const igraph_vector_t *weights,
...
static igraph_error_t igraph_i_pseudo_diameter_unweighted(const igraph_t *graph,
...
static igraph_error_t igraph_i_pseudo_diameter_dijkstra(const igraph_t *graph,
                                    const igraph_vector_t *weights,
                                    igraph_real_t *diameter,
                                    igraph_int_t vid_start,
                                    igraph_int_t *from,
