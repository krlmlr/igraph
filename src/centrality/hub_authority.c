...
igraph_error_t igraph_hub_score(const igraph_t *graph, igraph_vector_t *vector,
    ...
    IGRAPH_UNUSED(scale);
    return igraph_hub_and_authority_scores(graph, vector, NULL, value, weights, options);
}
...
igraph_error_t igraph_authority_score(const igraph_t *graph, igraph_vector_t *vector,
                           ...
                           igraph_arpack_options_t *options) {
    IGRAPH_UNUSED(scale);
    return igraph_hub_and_authority_scores(graph, NULL, vector, value, weights, options);
}
