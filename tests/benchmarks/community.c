...
int main(void) {
    ...
    igraph_erdos_renyi_game_gnm(&graph, 100, 500, false, IGRAPH_SIMPLE_SW, IGRAPH_EDGE_UNLABELED);
    rand_weights(&graph, &weights);
    run_bench(&graph, &weights, "G(n,m)", 1000);
    igraph_destroy(&graph);

    igraph_erdos_renyi_game_gnm(&graph, 1000, 5000, false, IGRAPH_SIMPLE_SW, IGRAPH_EDGE_UNLABELED);
    rand_weights(&graph, &weights);
    run_bench(&graph, &weights, "G(n,m)", 100);
    igraph_destroy(&graph);

    igraph_erdos_renyi_game_gnm(&graph, 1000, 50000, false, IGRAPH_SIMPLE_SW, IGRAPH_EDGE_UNLABELED);
    rand_weights(&graph, &weights);
    run_bench(&graph, &weights, "G(n,m)", 10);
    igraph_destroy(&graph);

    igraph_erdos_renyi_game_gnm(&graph, 10000, 50000, false, IGRAPH_SIMPLE_SW, IGRAPH_EDGE_UNLABELED);
    rand_weights(&graph, &weights);
    run_bench(&graph, &weights, "G(n,m)", 10);
    igraph_destroy(&graph);

    igraph_erdos_renyi_game_gnm(&graph, 100000, 500000, false, IGRAPH_SIMPLE_SW, IGRAPH_EDGE_UNLABELED);
    rand_weights(&graph, &weights);
