...
int main(void) {
    ...
    igraph_weighted_cliques(&graph, &vertex_weights, &result, /* maximal= */ false, 6, 0);
    ...
    igraph_weighted_cliques(&graph, &vertex_weights, &result, /* maximal= */ false, 5, 10);
    ...
    igraph_weighted_cliques(&graph, &vertex_weights, &result, /* maximal= */ true, 7, 0);
    ...
    igraph_weighted_cliques(&graph, &vertex_weights, &result, /* maximal= */ true, 5, 10);
    ...
    igraph_weighted_cliques(&graph, NULL, &result, /* maximal= */ false, 4, 5);
    ...
    igraph_weighted_cliques(&graph, NULL, &result, /* maximal= */ true, 4, 5);
    ...
    igraph_weighted_cliques(&graph, &vertex_weights, &result, /* maximal= */ false, 4, 5);
    ...
    igraph_weighted_cliques(&graph, &vertex_weights, &result, /* maximal= */ true, 4, 5);
