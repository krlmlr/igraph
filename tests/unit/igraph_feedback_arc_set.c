...
void test_undirected(void) {
    ...
    /* Random graph */
    igraph_erdos_renyi_game_gnm(&graph, 20, 40, IGRAPH_UNDIRECTED, IGRAPH_LOOPS_SW, IGRAPH_EDGE_UNLABELED);
    igraph_feedback_arc_set(&graph, &result, NULL, IGRAPH_FAS_APPROX_EADES);
    check_fas(&graph, &result);
    igraph_destroy(&graph);
...
void test_directed(void) {
    ...
    /* Acyclic graph */
    igraph_erdos_renyi_game_gnm(&graph, 20, 30, IGRAPH_DIRECTED, IGRAPH_SIMPLE_SW, IGRAPH_EDGE_UNLABELED);
    ...
    for (igraph_int_t m=10; m <= 60; m += 10) {
        igraph_erdos_renyi_game_gnm(&graph, 20, m, IGRAPH_DIRECTED, IGRAPH_LOOPS_SW, IGRAPH_EDGE_UNLABELED);
        compare_methods(&graph, NULL);
        rand_weights(&graph, &weights);
        compare_methods(&graph, &weights);
        igraph_destroy(&graph);
    ...
    igraph_erdos_renyi_game_gnm(&graph, 200, 400, IGRAPH_DIRECTED, IGRAPH_LOOPS_SW, IGRAPH_EDGE_UNLABELED);
    igraph_feedback_arc_set(&graph, &result, NULL, IGRAPH_FAS_EXACT_IP_CG);
    igraph_destroy(&graph);
