...
int main(void) {
    ...
    for (igraph_int_t i = 0; i <= 5; i++) {
        igraph_get_all_simple_paths(&g, &res, 0, igraph_vss_1(5), IGRAPH_ALL, i, -1, -1);
    ...
    printf("\nTEST MAXLEN\n\n");
    for (igraph_int_t i = 0; i <= 5; i++) {
        igraph_get_all_simple_paths(&g, &res, 0, igraph_vss_1(5), IGRAPH_ALL, -1, i, -1);
    ...
    igraph_get_all_simple_paths(&g, &res_all, 0, igraph_vss_1(5), IGRAPH_ALL, -1, -1, -1);
